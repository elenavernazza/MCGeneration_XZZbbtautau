...
# with command line options: Configuration/GenProduction/python/B2G-RunIIFall18wmLHEGS-01094-fragment.py --python_filename B2G-RunIIFall18wmLHEGS-01094_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:B2G-RunIIFall18wmLHEGS-01094.root --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int() --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 50
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/B2G-RunIIFall18wmLHEGS-01094-fragment.py nevts:50'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:B2G-RunIIFall18wmLHEGS-01094.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:B2G-RunIIFall18wmLHEGS-01094_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.6.0/exo_diboson/Spin-1/Zprime_Zh_Zhadbb/Zprime_Zh_Zhadhbb_narrow_M1000_slc6_amd64_gcc630_CMSSW_9_3_8_tarball.tar.xz'),
